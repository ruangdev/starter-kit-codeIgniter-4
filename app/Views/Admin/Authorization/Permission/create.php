                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="permissionName" class="form-control" placeholder="Permission Name..." value="<?= old('permissionName'); ?>"
                                    name="permissionName" autofocus>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="permissionDescription" class="form-control" placeholder="Permission Description..." value="<?= old('permissionDescription'); ?>"
